  ...
  describe('#compileFunctions()', () => {
    ...
    const compiledResources = {
      ...
      "sls-api-fc-invocation-role": {
        ...
        "Properties": {
          "RoleName": "sls-my-service-dev-api-role",
          "Description": "Allow Function Compute Service my-service-dev to be visited by API Gateway, generated by the Serverless framework",
