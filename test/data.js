...
exports.role = {
  'RoleName': 'sls-my-service-dev-cn-shanghai-invoke-role',
...
exports.execRole = {
  'RoleName': 'sls-my-service-dev-cn-shanghai-exec-role',
  ...
  'Policies': [
    {
      'PolicyName': 'fc-my-service-dev-cn-shanghai-access',
      'Description': 'Allow Function Compute service my-service-dev to access other services, generated by the Serverless framework',
      'PolicyDocument': {
        'Version': '1',
        'Statement': [
          {
            ...
            'Resource': [
              'acs:log:*:accountid:project/sls-accountid-cn-shanghai-logs/logstore/my-service-dev'
            ],
            'Effect': 'Allow'
          },
          {
...
exports.fullRole =  {
  ...
  'RoleName': 'sls-my-service-dev-cn-shanghai-invoke-role',
  'Arn': 'acs:ram::1234567890123456:role/sls-my-service-dev-cn-shanghai-invoke-role'
};

exports.fullExecRole =  {
  'RoleId': '901234223890123',
  'RoleName': 'sls-my-service-dev-cn-shanghai-exec-role',
  'Arn': 'acs:ram::1234567890123456:role/sls-my-service-dev-cn-shanghai-exec-role'
};
...
exports.service = {
  ...
  'logConfig': {
    ...
    'project': 'sls-accountid-cn-shanghai-logs'
  }
};
...
exports.bucket = {
  name: 'sls-accountid-cn-shanghai',
  region: 'cn-shanghai'
};
...
exports.logProject = {
  'projectName': 'sls-accountid-cn-shanghai-logs',
...
exports.fullTriggers = [{
  ...
  invocationRole: 'acs:ram::1234567890123456:role/sls-my-service-dev-cn-shanghai-invoke-role',
